...
<body class="w100">
<header>
   <%-- <jsp:include page="beforeHeader.jsp"></jsp:include>--%>
...
<script type="text/javascript">
    ...
    function getVideo(videoId) {
        ...
        //判断用户是否登录
        //alert($("#isLogin").val());
        if ((null != "${sessionScope.user.email}" && "${sessionScope.user.email}" != "") || ($("#isLogin").val() == 1)) {
            //如果登录
            location.href = "${pageContext.request.contextPath}/afterVideo/showVideo?id=" + videoId + "&subjectName=" + '${subject.subjectName}';
        } else {
            //如果不登录，弹登录框
